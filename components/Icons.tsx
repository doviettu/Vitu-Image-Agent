...
export const GalleryIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 7.125A2.25 2.25 0 014.5 4.875h15A2.25 2.25 0 0121.75 7.125v12.75a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V7.125zM5.25 14.625l3.375-3.375a1.125 1.125 0 011.591 0l3.375 3.375a1.125 1.125 0 01-1.59 1.59l-3.375-3.375-3.375 3.375a1.125 1.125 0 01-1.59-1.591z" />
  </svg>
);
